                            ...
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    ...
                                    <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href="detailProduct?id=${prolist.productID}"><i class="fa fa-shopping-cart"></i></a>
                                    </div>
                                </div>
                                <div class="text-center py-4">
                                    <a class="h6 text-decoration-none text-truncate" href="">${prolist.pname}</a>
                                    <div class="d-flex align-items-center justify-content-center mt-2">
                                        <h5>$ ${prolist.price}</h5><h6 class="text-muted ml-2"></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
