                                ...
                                <form action="maincontroller" method="POST" enctype="multipart/form-data">
                                    <div class="left-side">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control col-3" name="quantity" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Price </label>
                                            <input type="number" class="form-control col-3" name="price" required >
                                        </div>
                                    </div>
                                    <div class="right-side">
                                    ...
                                    <input name="action" value="addProduct" hidden="" />
                                    ...
                                    <tbody>
                                        <c:forEach var="lp" items="${listProduct}">
                                            <tr>
                                                ...
                                                <td>${lp.getPrice()}</td>
                                                <td>
                                                    <c:if test="${lp.getStatus() == 0}">
                                                        <a href="maincontroller?action=changeStatusProduct&id=${lp.getProductID()}">Display</a>
                                                    </c:if>
                                                    <c:if test="${lp.getStatus() == 1}">
                                                        <a href="maincontroller?action=changeStatusProduct&id=${lp.getProductID()}">Block  </a>
                                                    </c:if>
                                                        <a href="maincontroller?action=UpdateProduct&id=${lp.getProductID()}" class="text-success">Update</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
