<%-- 
    ...
    Created on : May 26, 2023, 7:26:32 PM
    Author     : msi
--%>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="tableProduct" class="dropdown-item">Product</a>
                            <a href="tableOrder" class="dropdown-item">Order</a>
                            <a href="voucher" class="dropdown-item">Voucher</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-table me-2"></i>News</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="AddNews.jsp" class="dropdown-item">Add news</a>
                            <a href="#" class="dropdown-item">Table News</a>
